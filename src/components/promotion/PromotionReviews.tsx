...
interface PromotionReviewsProps {
  promotionId: string;
}

const PromotionReviews = ({ promotionId }: PromotionReviewsProps) => {
  ...
  const reviews = [
    {
      ...
      rating: 5,
      date: '2024-03-15',
      comment: 'Excelente promoção! O café estava delicioso e o atendimento foi ótimo.',
    ...
    },
    {
      ...
      rating: 4,
      date: '2024-03-10',
      comment: 'Boa promoção, valeu muito a pena. Recomendo!',
  ...
  return (
    <section className="bg-white rounded-lg shadow-sm p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button variant="outline">Avaliar Promoção</Button>
      </div>
